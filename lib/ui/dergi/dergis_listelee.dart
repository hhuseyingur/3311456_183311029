...
class DergiListelee extends StatefulWidget {
  const DergiListelee({Key? key}) : super(key: key);

  @override
  State<DergiListelee> createState() => _DergiListeleeState();
}

class _DergiListeleeState extends State<DergiListelee> {
  final Stream<QuerySnapshot> dergilerStream =
